        ...
        function q() {
            a.modal && b(".b-modal." + c.data("id")).fadeTo(a.speed, 0, function() {
                ...
                $(".modal-wrapper").each(function(index, element){
                    if(element.className != "modal-wrapper signin-modal-wrapper" && element.className != "modal-wrapper option-modal-wrapper" && element.className != "modal-wrapper public-modal" && element.className != "modal-wrapper admin-modal" && element.className != "modal-wrapper subscription-modal" && element.className != "modal-wrapper account-modal" && element.className != "modal-wrapper leader-modal" && element.className != "modal-wrapper user-lock-modal" && element.className != "modal-wrapper gradeless-modal"){
                        var content = element.innerHTML;
                        element.innerHTML = "";
                        element.innerHTML = content;
                    }
                    if(element.className == "modal-wrapper modal-youtube-video test-video-modal"){
                        element.innerHTML = '<div class="b-close"></div><div id="video_player"></div>';
                        if($(element).css('display') == 'block' && typeof onPlayerStop === 'function'){
                            onPlayerStop();
                        }
                    }
                });
